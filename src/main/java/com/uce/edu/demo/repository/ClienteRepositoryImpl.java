...
public class ClienteRepositoryImpl implements IClienteRepository {
	...
	public List<Cliente> buscarApellido(String apellido) {
		// TODO Auto-generated method stub
		TypedQuery<Cliente>query=this.entityManager.createQuery("SELECT c FROM Cliente c WHERE c.apellido=:datoApellido ", Cliente.class);
	...
	public int actualizar(Cliente cliente) {
		...
		Query myQuery = this.entityManager
				.createQuery("UPDATE Cliente c SET c.nombre=:datoNombre, c.apellido=:datoApellido, c.fechaNacimiento=:datoFechaNacimiento, c.genero=:datoGenero WHERE c.cedula = :datoCedula");
