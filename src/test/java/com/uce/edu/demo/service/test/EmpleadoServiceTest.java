...
public class EmpleadoServiceTest {
	...
	void testVehiculosVIP() {
		...
		this.iGestorReservasService.reservarVehiculo("PAW-1298", "05031515", LocalDateTime.of(2022, 9, 21, 0, 0),
				LocalDateTime.of(2022, 9, 23, 0, 0));

		List<VehiculoVIP> listaVIP = this.empleadoService.vehiculosVIP("2022", "09");
